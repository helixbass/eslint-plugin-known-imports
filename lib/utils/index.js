...
(function() {
  var ExportMap, INDEX_PATH_REGEX, NON_ROOT_DIRECTORY_IGNORE_PATTERN_REGEX, PARENT_DIRECTORY_NAME_REGEX, addDefaultBlacklist, appendToCacheKey, configFileBasenames, createDirectoryCache, defaultBlacklist, directoryCaches, ensureArray, ensureLeadingDot, ffilter, findKnownImport, findKnownImportInDirectory, first, fmapValues, fs, getAddImportFix, getExportMap, getExtensions, getIsNonRootDirectoryPattern, getParentDirectoryName, getRemoveImportFix, isArray, isFresh, isString, knownImportExists, knownImportsCache, last, loadConfigFile, loadKnownImports, mergeKnownImportsField, mergeWith, normalizeKnownImportValue, normalizeKnownImports, normalizePath, pathModule, picomatch, pkgDir, shouldIncludeBlankLineBeforeLocalImports, sortBy, startsWith, stripIndex, takeWhile, updateDirectoryCache,
    indexOf = [].indexOf;
  ...
  createDirectoryCache = function({
    ...
    scanDir = function(dir) {
      var dirName, exports, ext, file, fullPath, i, len, name, namedExport, prefixRelativePath, ref, ref1, relativePathWithExtension, results;
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
          ...
          if (name === 'index' && prefixRelativePath) {
            ...
            fullPath = fullPath.replace(RegExp(`/index${ext}$`), '');
          }
