...
(function() {
  ...
  // Rule Definition
  // ------------------------------------------------------------------------------
  BUILTIN_UTILITY_TYPES = ['Partial', 'Readonly', 'Record', 'Pick', 'Omit', 'Exclude', 'Extract', 'NonNullable', 'Parameters', 'ConstructorParameters', 'ReturnType', 'InstanceType', 'Required', 'ThisParameterType', 'OmitThisParameter', 'ThisType', 'Uppercase', 'Lowercase', 'Capitalize', 'Uncapitalize'];
    ...
    create: function(context) {
      ...
      return {
        ...
        'Program:exit': function(/* node */) {
          var identifier, identifierName, ref, ref1, results;
          ref = allIdentifiersWhichAreTypeReferences;
          results = [];
          for (identifierName in ref) {
            identifier = ref[identifierName];
            if (!allIdentifiersBesidesTypeReferences[identifierName] && !ALL_BUILTIN_TYPES_LOOKUP[identifierName] && indexOf.call((ref1 = context.settings['known-imports/global-types']) != null ? ref1 : [], identifierName) < 0) {
