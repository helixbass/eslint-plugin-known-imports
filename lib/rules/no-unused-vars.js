...
(function() {
   ...
   */
  'use strict';
  var astUtils, getRemoveImportFix, lodash;
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       * @private
       */
      var REST_PROPERTY_TYPE, STATEMENT_TYPE, collectUnusedVariables, config, firstOption, getAssignedMessage, getColumnInComment, getDefinedMessage, getLocation, getRhsNode, hasRestSpreadSibling, isAfterLastUsedArg, isExported, isForInRef, isInside, isInsideOfStorableFunction, isReadForItself, isReadRef, isSelfReference, isStorableFunction, isUsedVariable, sourceCode;
