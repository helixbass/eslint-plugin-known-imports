...
(function() {
   ...
   */
  'use strict';
  var astUtils, loadKnownImports, lodash;
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       * @private
       */
      var REST_PROPERTY_TYPE, STATEMENT_TYPE, collectUnusedVariables, config, firstOption, getAssignedMessage, getColumnInComment, getDefinedMessage, getFix, getLocation, getRhsNode, hasRestSpreadSibling, isAfterLastUsedArg, isExported, isForInRef, isInside, isInsideOfStorableFunction, isReadForItself, isReadRef, isSelfReference, isStorableFunction, isUsedVariable, knownImports, sourceCode;
      ...
      knownImports = config.onlyRemoveKnownImports && loadKnownImports();
      ...
      getFix = function({unusedVar}) {
        ...
        return function(fixer) {
          ...
          removeEntireImport = function() {
            ...
            return fixer.removeRange([importDeclaration.range[0], nextToken.range[0]]);
          };
