...
(function() {
  var RuleTester, eslint, parserOptions, rule, ruleTester;
...
React.render(<View />)`,
        output: `import {ScrollView, View} from 'react-native'
...
React.render(<View />)`,
      ...
      {
        code: `import a from 'react-native'

React.render(<View />)`,
        output: `import a, {View} from 'react-native'
