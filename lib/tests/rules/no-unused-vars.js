...
(function() {
   ...
   */
  var RuleTester, definedError, eslint, parserOptions, rule, ruleTester;
...
export {y};`,
      ...
      {
        code: `import {w, x, y} from "y";
export {w, y};`,
        output: `import {w, y} from "y";
export {w, y};`,
        errors: [definedError('x')],
        options: [
          {
      ...
      {
        code: `import {w, x} from "y";
export {w};`,
        output: `import {w} from \"y\";
export {w};`,
        errors: [definedError('x')],
        options: [
          {
...
export {w};`,
      ...
      {
        code: `import {w, y as x, z} from \"y\";
export {w, z};`,
        output: `import {w, z} from "y";
export {w, z};`,
        errors: [definedError('x')],
        options: [
          {
      ...
      {
        code: `import {y as x, z} from "y";
export {z};`,
        output: `import {z} from "y";
export {z};`,
        errors: [definedError('x')],
        options: [
          {
...
export const a = 1;`,
        output: `import numeral from "numeral";
export const a = 1;`,
...
export const a = someLocalDependency;`,
        output: `import someLocalDependency from "../somewhere";
...
export const a = someLocalDependency;`,
      ...
      },
      {
        ...
        code: `import Empty from "fixtures/Empty";
export const a = 1;`,
        output: `export const a = 1;`,
      ...
      },
      {
        ...
        code: `import {one} from "fixtures/named";
export const a = 1;`,
        output: `export const a = 1;`,
