...
Empty()`,
      ...
      },
      {
        ...
        code: `Empty2()`,
        output: `import Empty2 from 'fixtures/empty2'
...
Empty2()`,
        ...
        settings: {
          'known-imports/case-insensitive-whitelist-filename': true
        }
      },
      {
...
Empty()`,
      ...
      },
      {
        ...
        code: `Empty()`,
        settings: {
          'known-imports/relative-paths': true
        },
        output: `import Empty from './tests/fixtures/Empty'
...
Empty()`,
      ...
      },
      {
        ...
        code: `ambiguous()`,
        output: `import {ambiguous} from 'fixtures/nested/ambiguous2'
...
ambiguous()`,
      ...
      },
      {
        ...
        code: `ambiguous()`,
        output: `import {ambiguous} from 'fixtures/ambiguous1'
...
ambiguous()`,
      ...
      },
      {
        ...
        code: `ignTopLevelNested()`,
        output: `import ignTopLevelNested from 'fixtures/nested/ignoredTopLevel/ignTopLevelNested'
...
ignTopLevelNested()`,
      ...
      },
      {
        ...
        code: `namedLikeFilename()`,
        output: `import {namedLikeFilename} from 'fixtures/namedLikeFilename'
...
namedLikeFilename()`,
      ...
      },
      {
        // index.js named
        code: `fromIndex()`,
        output: `import {fromIndex} from 'fixtures/subdir'
...
fromIndex()`,
      ...
      },
      {
        // index.js default
        code: `subdir()`,
        output: `import subdir from 'fixtures/subdir'
